...
# Ouverture du fichier du Dataset et et initialisation d'une matrice
...
for i in tqdm(range(len(ds))):
    ...
    if i < 28709:
        if ds["emotion"][i] == 0:
            img.save("data/train/angry/im" + str(angry_train) + ".png")
            angry_train += 1
        elif ds["emotion"][i] == 1:
            img.save("data/train/disgusted/im" + str(disgusted_train) + ".png")
            disgusted_train += 1
        elif ds["emotion"][i] == 2:
            img.save("data/train/fearful/im" + str(fearful_train) + ".png")
            fearful_train += 1
        elif ds["emotion"][i] == 3:
            img.save("data/train/happy/im" + str(happy_train) + ".png")
            happy_train += 1
        elif ds["emotion"][i] == 4:
            img.save("data/train/sad/im" + str(sad_train) + ".png")
            sad_train += 1
        elif ds["emotion"][i] == 5:
            img.save("data/train/surprised/im" + str(surprised_train) + ".png")
            surprised_train += 1
        elif ds["emotion"][i] == 6:
            img.save("data/train/neutral/im" + str(neutral_train) + ".png")
            neutral_train += 1
...
histo.title("Distributuon du Dataset fer2013")
...
histo.savefig("fer2013_distribution.png")
histo.show()
